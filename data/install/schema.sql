...
ALTER TABLE bulk_export ADD CONSTRAINT FK_625A30FDB4523DE5 FOREIGN KEY (exporter_id) REFERENCES bulk_exporter (id);
ALTER TABLE bulk_export ADD CONSTRAINT FK_625A30FDBE04EA9 FOREIGN KEY (job_id) REFERENCES job (id);
