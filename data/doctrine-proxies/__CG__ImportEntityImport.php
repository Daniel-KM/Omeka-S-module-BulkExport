 ...
 */
class Import extends \Import\Entity\Import implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['reader_params' => NULL, 'processor_params' => NULL, 'status' => NULL, 'started' => NULL, 'ended' => NULL, 'importer' => NULL];
    ...
    {
        unset($this->reader_params, $this->processor_params, $this->status, $this->started, $this->ended, $this->importer);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'reader_params', 'processor_params', 'status', 'started', 'ended', 'importer'];
        }
