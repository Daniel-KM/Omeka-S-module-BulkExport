 ...
 */
class Shaper extends \BulkExport\Entity\Shaper implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'label', 'config', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Shaper $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOwner(?\Omeka\Entity\User $owner): \BulkExport\Entity\Shaper
    {
     ...
     * {@inheritDoc}
     */
    public function setLabel(string $label): \BulkExport\Entity\Shaper
    {
     ...
     * {@inheritDoc}
     */
    public function setConfig($config): \BulkExport\Entity\Shaper
    {
