...
class Export extends \BulkExport\Entity\Export implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'exporter', 'owner', 'job', 'comment', 'params', 'filename'];
        }
     ...
     * {@inheritDoc}
     */
    public function setComment($comment): \BulkExport\Entity\Export
    {
     ...
     * {@inheritDoc}
     */
    public function setParams(array $params): \BulkExport\Entity\Export
    {
