...
class BulkExportSearch implements ResourcePageBlockLayoutInterface
{
    public function getLabel() : string
    {
        return 'Bulk export (search)'; // @translate
    }
    ...
    public function render(PhpRenderer $view, AbstractResourceEntityRepresentation $resource) : string
    {
        ...
        return $view->partial('common/resource-page-block-layout/bulk-export-search', [
            'query' => $query,
        ]);
    }
}
